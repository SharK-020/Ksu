	...
	return (
		<>
			...
			<div className=" ">
				{/* The Mission Div*/}
				<div
					className="shadow-sm text-white flex flex-col justify-center
        bg-sky-800 transition-all rounded-md items-center
         p-10 md:p-16 lg:p-20 space-y-6">
					...
					<div className="font-sanserif flex justify-center w-[80%] text-justify md:text-md lg:text-lg font-medium">
						...
						elit. Nesciunt, veniam! A magnam amet sunt esse nostrum
						minima perferendis qui in.
					</div>
				</div>
			</div>
		</>
