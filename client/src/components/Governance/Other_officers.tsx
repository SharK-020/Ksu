    ...
    <main className='space-y-4 bg-slate-100 mx-2 md:mx-3'>
            ...
            <div className='p-1 py-2 overflow-auto rounded-lg shadow space-y-1'>
                <div className='flex justify-center'>
                    <h1 className='font-semibold'>Administration Division</h1>
                ...
                <table className='w-full'>
                    ...
                    <tbody className='divide-y  divide-gray-400'>
                        <tr className=''>
                            ...
                            <td className='p-3 text-sm text-gray-900  whitespace-nowrap'><a href="#" className='font-semibold text-blue-500 hover:underline'>	
ssu.assistantregistrar@gmail.com</a></td>
                            <td className='p-3 text-sm text-gray-900 whitespace-nowrap'>7908827952</td>
                        </tr>
                        <tr className=''>
                        <td className='p-3 text-sm text-gray-900  whitespace-nowrap'>1</td>
            ...
            <div className='p-1 overflow-auto rounded-lg shadow space-y-1'>
                <div className='flex justify-center'>
                    <h1 className='font-semibold'>Examination Division</h1>
            ...
            <div className='p-1 pb-3 overflow-auto rounded-lg shadow space-y-1'>
                <div className='flex justify-center'>
                    <h1 className='font-semibold'>Finance and Accounts Division </h1>
